...
public class RegistrarRedActivity extends AppCompatActivity implements View.OnClickListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_registrar_red);
    ...
    private void registrar(final String correo, final String clave, final String nombre, final String apellido, final String telefono, final String rut){
        class UserLoginClass extends AsyncTask<String,Void,String> {
            ...
            protected void onPreExecute() {
                super.onPreExecute();
                loading = ProgressDialog.show(RegistrarRedActivity.this,"Espere por favor",null,true,true);
            }
            ...
            protected void onPostExecute(String s) {
                ...
                if(s.equalsIgnoreCase("registrado")){
                    Toast.makeText(RegistrarRedActivity.this,"registrado exitosamente",Toast.LENGTH_LONG).show();
                    finish();

                }else{
                    Toast.makeText(RegistrarRedActivity.this,"error en el registro",Toast.LENGTH_LONG).show();
                }
            }
